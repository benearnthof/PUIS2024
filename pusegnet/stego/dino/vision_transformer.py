...
Added for backwards compatibility with DINOv1. 
Based on original STEGO implementation: 
https://github.com/mhamilton723/STEGO/blob/master/src/dino/vision_transformer.py
"""
import math
