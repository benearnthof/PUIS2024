...
from pusegnet.stego.crf import dense_crf
from omegaconf import DictConfig, OmegaConf
from torch.utils.data import DataLoader
from tqdm import tqdm
from pusegnet.stego.train_segmentation import LitUnsupervisedSegmenter, prep_for_plot, get_class_labels

import wandb
import numpy as np
from pusegnet.stego.mxm_utils import setup_wandb, safe_wandb_log
...
def my_app(cfg: DictConfig) -> None:
    ...
    setup_wandb(cfg, key=cfg.WANDBKEY) # TODO: make sure training works when passing in key
